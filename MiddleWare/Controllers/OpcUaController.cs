...
using MiddleWare.Models.DataSet;
...
namespace API.Controllers
{
    ...
    public class OpcUaController : BaseApiController
    {
        ...
        //private readonly ModelServerContext modelServer; 
        /// <summary>
        ...
        public OpcUaController(IOptions<OPCUAServersOptions> servers, IUaClientSingleton UAClient) //,ModelServerContext modelServer)
        {
        ...
        /// <returns></returns>
        [HttpGet("data-sets/route/expand")]
        public async Task<IActionResult> GetExpandNode()
        {
            string node_id = "2-15039";
            ...
            try
            {
                var getAllNode = new GetAllNode(_uaClient);
                JObject result = await getAllNode.GetAllNodes(serverUrl, decodedNodeId);
                Result = result;
            }
        ...
        //[HttpGet("data-sets/route/get-tree")]
        //public async Task<IActionResult> GetExpandNodes(string node_id = "2-15040")
        //{
        //    var decodedNodeId = WebUtility.UrlDecode(node_id);
        //    string serverUrl = _uaServers[0].Url;
        //    if (!(await _uaClient.IsServerAvailable(serverUrl)))
        ...
        //    try
        //    {
        //        var tree = new ConvertJsonObjectToModel(_uaClient);
        //        TreeOpcUa<ModelOfNode> treeOpcUa = await tree.ConvertModel(serverUrl, decodedNodeId);
        //        modelServer.treeOpcUas.Add(treeOpcUa);
        //        await modelServer.SaveChangesAsync();
        //        return Ok(treeOpcUa);
        //    }
        //    catch (ServiceResultException exc)
        //    {
        ...
        public async Task<IActionResult> BrowserModel(string node_id = "0-85")
        {
        ...
        [HttpGet("data-sets/browsing-tree")]
        public async Task<IActionResult> Printing2Model(string node_id)
        {
            return Ok("123");
        }
            ...
            try
            {
                ...
                switch (sourceNode.NodeClass)
                {
                    ...
                    case NodeClass.Variable:
                        ...
                        result["value_schema"] = uaValue.Schema.ToString();
